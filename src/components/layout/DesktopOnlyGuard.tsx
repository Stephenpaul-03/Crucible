      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#050608] px-6 text-center text-zinc-100">
        <div className="max-w-sm">
          ...
          <h1 className="mt-6 text-2xl font-semibold tracking-normal">
            I’ve built Crucible for desktop—for now.
          </h1>
          <p className="mt-3 text-sm leading-6 text-zinc-400">
            I use wide layouts and side-by-side references while documenting my
            projects, so the site currently works best on a larger screen.
          </p>
        </div>
      </div>
    )
